        ...
        <section id="halaman2">
            <div class="container second-container">
                <h2 class="h2-1 pb-4">Regulasi Peminjaman</h2>
                    <div class="card mb-3">
                    <ol class="kotak">
                        <li>Kunjungi situs web <a href="http://spacegojti.polinema.ac.id" target="_blank">http://spacegojti.polinema.ac.id</a>.</li>
                        <li>Daftarkan diri Anda dengan mengisi formulir pendaftaran untuk membuat akun baru.</li>
                        <li>Setelah akun berhasil dibuat, masuk ke dalam sistem dengan memasukkan username dan password Anda.</li>
                        ...
                        <li>Jika peminjaman Anda telah disetujui oleh admin, Anda dapat memeriksa hal tersebut di menu riwayat.</li>
                        ...
                        <li>Simpan surat peminjaman aslinya dan buatlah salinan dari surat peminjaman tersebut untuk diberikan kepada Pamdal dan OB dari gedung yang Anda pinjam.</li>
                    </ol>
                </div>
            </div>
        </section>
